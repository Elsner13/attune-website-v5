  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50" style={{ background: 'rgba(8,8,6,0.95)', backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
      <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <a href="https://attunemastery.com/checkout" className="text-white text-[10px] tracking-[0.12em] uppercase px-3.5 py-1.5 transition-colors" style={{ fontFamily: 'var(--font-mono)', background: '#E11D48' }}>Enroll — $197</a>
      </div>
    </nav>
  )
}
